...
<p><a style='font-size: 16px;cursor: pointer;' @click="openViewer">Single images</a></p>
<p><a style='font-size: 16px;cursor: pointer;' @click="openViewer2">Multiple images | Custom buttons | Trigger events</a></p>
<p><a style='font-size: 16px;cursor: pointer;' @click="openViewer3">Multiple images | Cache optimization | Thumbnails</a></p>
